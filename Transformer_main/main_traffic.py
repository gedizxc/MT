...
parser.add_argument('--model_id', type=str, required=False, default='traffic_96_', help='model id')
...
# data loader
parser.add_argument('--data', type=str, required=False, default='traffic', help='dataset type')
