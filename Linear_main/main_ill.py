...
parser.add_argument('--noise_step', type=int, default=10, help='diffusion noise step') #1000
parser.add_argument('--sample_num', type=int, default=10, help='diffusion sample_num')

# data loader
parser.add_argument('--data', type=str, required=False, default='ill', help='dataset type')
parser.add_argument('--root_path', type=str, default='../dataset', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='ill.csv', help='data file')
...
parser.add_argument('--learning_rate', type=float, default=0.01, help='optimizer learning rate')#0.0001
