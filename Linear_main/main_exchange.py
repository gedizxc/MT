...
parser.add_argument('--model_id', type=str, required=False, default='exchange_96_', help='model id')
parser.add_argument('--model', type=str, required=False, default='NLinear',
                    help='Informer, Transformer,Linear,NLinear')              ####
...
# data loader
parser.add_argument('--data', type=str, required=False, default='exchange', help='dataset type')
parser.add_argument('--root_path', type=str, default='../dataset', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='exchange.csv', help='data file')
...
# forecasting task
parser.add_argument('--seq_len', type=int, default=336, help='input sequence length') #96最佳
